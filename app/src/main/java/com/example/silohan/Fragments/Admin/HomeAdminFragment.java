...
public class HomeAdminFragment extends Fragment {
    ...
    private MaterialCardView perumahanCV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        welcomeTV = (TextView) v.findViewById(R.id.welcomeAdminTV);
        perumahanCV = (MaterialCardView) v.findViewById(R.id.admin_daftarperumahanCardView);
        ...
        perumahanCV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), PerumahanActivityAdmin.class));
            }
        });
